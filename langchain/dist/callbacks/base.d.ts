...
export declare class ConsoleCallbackHandler extends BaseCallbackHandler {
    handleChainStart(chain: {
        name: string;
    }, _inputs: ChainValues, _verbose?: boolean): Promise<void>;
    handleChainEnd(_output: ChainValues, _verbose?: boolean): Promise<void>;
    handleAgentAction(action: AgentAction, _verbose?: boolean): Promise<void>;
    handleToolEnd(output: string, _verbose?: boolean): Promise<void>;
    handleText(text: string, _verbose?: boolean): Promise<void>;
    handleAgentEnd(action: AgentFinish, _verbose?: boolean): Promise<void>;
}
export {};
